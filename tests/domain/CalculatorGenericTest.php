...
class CalculatorGenericTest extends PHPUnit_Framework_TestCase
{
     ...
     * @param int $abs
     */
    public function calculateLowestAndHighestCalculatesCorrectly($values, $currentState, $lowest, $highest, $abs)
    {
        $expectation = [
            'negativeMin' => $lowest,
            'positiveMax' => $highest
     ...
     * @param int $abs
     */
    public function calculateAbsoluteCalculatesCorrectly($values, $currentState, $lowest, $highest, $abs)
    {
        $expectation = [
            'absolute' => $abs
        ];
    ...
    public function valuesProvider()
    {
        return [
            ...
            [
                [-10, 5],
                ['balance' => 0, 'negative' => -10, 'positive' => 5],
                -10,
                0,
                15
            ],
